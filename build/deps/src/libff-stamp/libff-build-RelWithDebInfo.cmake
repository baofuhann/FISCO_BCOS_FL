...
set(command "/usr/local/bin/cmake;--build;/Users/hanallen/go/src/fisco/FISCO-BCOS/build/deps/src/libff-build;--config;Release")
set(log_merged "")
set(log_output_on_failure "")
set(stdout_log "/Users/hanallen/go/src/fisco/FISCO-BCOS/build/deps/src/libff-stamp/libff-build-out.log")
set(stderr_log "/Users/hanallen/go/src/fisco/FISCO-BCOS/build/deps/src/libff-stamp/libff-build-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /Users/hanallen/go/src/fisco/FISCO-BCOS/build/deps/src/libff-stamp/libff-build-*.log")
  endif()
  ...
  if(NOT "Unix Makefiles" MATCHES "Ninja")
    set(msg "libff build command succeeded.  See also /Users/hanallen/go/src/fisco/FISCO-BCOS/build/deps/src/libff-stamp/libff-build-*.log")
    message(STATUS "${msg}")
  endif()
endif()
