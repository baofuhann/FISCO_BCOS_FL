# 联邦学习参考代码
`https://github.com/AshwinRJ/Federated-Learning-PyTorch.git`和`https://github.com/shaoxiongji/federated-learning.git`
# FLSys模块的作用
该模块是模拟的是原始FL的执行过程，并不涉及到区块链，可以作为后续的baseline
