...
set(stdout_log "/Users/hanallen/go/src/fisco/FISCO-BCOS/deps/src/secp256k1-stamp/secp256k1-build-out.log")
set(stderr_log "/Users/hanallen/go/src/fisco/FISCO-BCOS/deps/src/secp256k1-stamp/secp256k1-build-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /Users/hanallen/go/src/fisco/FISCO-BCOS/deps/src/secp256k1-stamp/secp256k1-build-*.log")
  endif()
  ...
  if(NOT "Unix Makefiles" MATCHES "Ninja")
    set(msg "secp256k1 build command succeeded.  See also /Users/hanallen/go/src/fisco/FISCO-BCOS/deps/src/secp256k1-stamp/secp256k1-build-*.log")
    message(STATUS "${msg}")
  endif()
endif()
