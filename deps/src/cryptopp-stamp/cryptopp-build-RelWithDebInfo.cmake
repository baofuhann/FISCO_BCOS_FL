...
set(command "/usr/local/bin/cmake;--build;/Users/hanallen/go/src/fisco/FISCO-BCOS/deps/src/cryptopp-build;--config;Release")
set(log_merged "")
set(log_output_on_failure "")
set(stdout_log "/Users/hanallen/go/src/fisco/FISCO-BCOS/deps/src/cryptopp-stamp/cryptopp-build-out.log")
set(stderr_log "/Users/hanallen/go/src/fisco/FISCO-BCOS/deps/src/cryptopp-stamp/cryptopp-build-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /Users/hanallen/go/src/fisco/FISCO-BCOS/deps/src/cryptopp-stamp/cryptopp-build-*.log")
  endif()
  ...
  if(NOT "Unix Makefiles" MATCHES "Ninja")
    set(msg "cryptopp build command succeeded.  See also /Users/hanallen/go/src/fisco/FISCO-BCOS/deps/src/cryptopp-stamp/cryptopp-build-*.log")
    message(STATUS "${msg}")
  endif()
endif()
