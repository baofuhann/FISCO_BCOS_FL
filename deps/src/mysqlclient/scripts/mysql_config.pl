...
my $ldata   = '/Users/hanallen/go/src/fisco/FISCO-BCOS/deps/data';
my $execdir = '/Users/hanallen/go/src/fisco/FISCO-BCOS/deps/bin';
my $bindir  = '/Users/hanallen/go/src/fisco/FISCO-BCOS/deps/bin';

# ----------------------------------------------------------------------
# If installed, search for the compiled in directory first (might be "lib64")
# ----------------------------------------------------------------------

my $pkglibdir = fix_path('/Users/hanallen/go/src/fisco/FISCO-BCOS/deps/lib',"libmysql/relwithdebinfo",
                         "libmysql/release","libmysql/debug","lib/mysql","lib");

my $pkgincludedir = fix_path('/Users/hanallen/go/src/fisco/FISCO-BCOS/deps/include', "include/mysql", "include");
