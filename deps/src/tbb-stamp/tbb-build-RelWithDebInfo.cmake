...
set(command "make;extra_inc=big_iron.inc;stdlib=libc++")
set(log_merged "")
set(log_output_on_failure "")
set(stdout_log "/Users/hanallen/go/src/fisco/FISCO-BCOS/deps/src/tbb-stamp/tbb-build-out.log")
set(stderr_log "/Users/hanallen/go/src/fisco/FISCO-BCOS/deps/src/tbb-stamp/tbb-build-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /Users/hanallen/go/src/fisco/FISCO-BCOS/deps/src/tbb-stamp/tbb-build-*.log")
  endif()
  ...
  if(NOT "Unix Makefiles" MATCHES "Ninja")
    set(msg "tbb build command succeeded.  See also /Users/hanallen/go/src/fisco/FISCO-BCOS/deps/src/tbb-stamp/tbb-build-*.log")
    message(STATUS "${msg}")
  endif()
endif()
