...
set(command "bash;-c;/bin/cp -f */libtbb.a* /Users/hanallen/go/src/fisco/FISCO-BCOS/deps/lib/")
set(log_merged "")
set(log_output_on_failure "")
set(stdout_log "/Users/hanallen/go/src/fisco/FISCO-BCOS/deps/src/tbb-stamp/tbb-install-out.log")
set(stderr_log "/Users/hanallen/go/src/fisco/FISCO-BCOS/deps/src/tbb-stamp/tbb-install-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  /Users/hanallen/go/src/fisco/FISCO-BCOS/deps/src/tbb-stamp/tbb-install-*.log")
  endif()
  ...
  if(NOT "Unix Makefiles" MATCHES "Ninja")
    set(msg "tbb install command succeeded.  See also /Users/hanallen/go/src/fisco/FISCO-BCOS/deps/src/tbb-stamp/tbb-install-*.log")
    message(STATUS "${msg}")
  endif()
endif()
